 ...
 * generated in the com.mycompany.rulebase package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetBanks_QNAME = new QName("http://rulebase.mycompany.com/", "getBanks");
    private final static QName _GetBanksResponse_QNAME = new QName("http://rulebase.mycompany.com/", "getBanksResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycompany.rulebase
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rulebase.mycompany.com/", name = "getBanks")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rulebase.mycompany.com/", name = "getBanksResponse")
