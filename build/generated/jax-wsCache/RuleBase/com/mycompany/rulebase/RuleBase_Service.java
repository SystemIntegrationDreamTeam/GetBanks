 ...
 * 
 */
@WebServiceClient(name = "RuleBase", targetNamespace = "http://rulebase.mycompany.com/", wsdlLocation = "http://localhost:8080/RuleBase/RuleBase?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RULEBASE_QNAME = new QName("http://rulebase.mycompany.com/", "RuleBase");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/RuleBase/RuleBase?wsdl");
    ...
    public RuleBase getRuleBasePort() {
        return super.getPort(new QName("http://rulebase.mycompany.com/", "RuleBasePort"), RuleBase.class);
    }
    ...
    public RuleBase getRuleBasePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://rulebase.mycompany.com/", "RuleBasePort"), RuleBase.class, features);
    }
